...
import { MODULES, EVENTS, SCROLL_NAVIGATOR } from './constants.js'

export class NavigationManager extends EleganceModule {
    constructor(themeConfig = {}) {
        super(MODULES.NAVIGATION_MANAGER, themeConfig);
        this.state = {
...
export class EleganceNavigation {
...
export class EleganceNavigationItem {    
