...
if (!function_exists('elegance_theme_customizer_settings')) {
    function elegance_theme_customizer_settings($wp_customize) {
        ...
        *************************************/        
        ...
        // Testimonials Navigation Settings
        $wp_customize->add_setting('nav_testimonials_label', array(
            'default' => __('Testimonials', 'wordpress-theme-elegance'),
            'sanitize_callback' => 'sanitize_text_field',
            'transport' => 'refresh',
        ));

        $wp_customize->add_control('nav_testimonials_label', array(
            'label' => __('Testimonials Menu Label', 'wordpress-theme-elegance'),
            'section' => 'theme_navigation_settings',
            'type' => 'text',
        ));
        ...
        *************************************/
        ...
        $wp_customize->add_setting('social_icons', array(
            ...
            'sanitize_callback' => 'elegance_sanitize_social_icons',
        ));
    ...
    function elegance_sanitize_social_icons($input) {
        ...
        if (!empty($input_decoded)) {
            foreach ($input_decoded as $key => $value) {
                if ($input_decoded[$key]['title'] !== 'Email') {
