...
function register_work_block() {
    ...
    wp_register_script(
        ...
        get_template_directory_uri() . '/blocks/work-block/index.js',
        array('wp-blocks', 'wp-element', 'wp-editor', 'wp-components')
    );
    ...
    wp_register_script(
        ...
        get_template_directory_uri() . '/blocks/work-block/frontend.js',
        array('jquery'),
        null,
        true
    );
    ...
    wp_register_style(
        ...
        get_template_directory_uri() . '/blocks/work-block/style.css'
    );
